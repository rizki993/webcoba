                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="card-body">
                      ...
                      <p class="card-description">Use
                        <code>class="btn-icons"</code> or
                        <code>class="btn-icons btn-rounded"</code> for fab styled buttons</p>
                      <div class="template-demo">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="card-body">
                      ...
                      <p class="card-description">Use
                        <code>class="btn-outline-*"</code> for outlined style</p>
                      <div class="template-demo">
                  ...
                  <div class="col-md-6">
                    <div class="card-body">
                      ...
                      <p class="card-description">Use
                        <code>class="btn-outline-* btn-rounded"</code> for rounded outlined style</p>
                      <div class="template-demo">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="card-body">
                      ...
                      <p class="card-description">Use
                        <code>class="btn-inverse-*"</code> for inverse styling</p>
                      <div class="template-demo">
                  ...
                  <div class="col-md-6">
                    <div class="card-body">
                      ...
                      <p class="card-description">Use class
                        <code>"btn-lg", "btn-sm"</code> for different sizing</p>
                      <div class="template-demo">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="card-body">
                      ...
                      <p class="card-description">Use class
                        <code>.btn-rounded</code> for rounded buttons</p>
                      <div class="template-demo">
                  ...
                  <div class="col-md-6">
                    <div class="card-body">
                      ...
                      <p class="card-description">Use class
                        <code>.btn-rounded</code> for rounded style</p>
                      <div class="template-demo">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-description">Use class
                        <code>.btn-block</code> for full width buttons</p>
                      <div class="template-demo">
                ...
                <div class="row">
                  <div class="col-6">
                    <div class="card-body">
                      ...
                      <p class="card-description">use class
                        <code>.social-btn</code> for social button</p>
                      <div class="template-demo">
                  ...
                  <div class="col-6">
                    <div class="card-body">
                      ...
                      <p class="card-description">use class
                        <code>".social-btn", ".btn-rounded"</code> for social button</p>
                      <div class="template-demo">
